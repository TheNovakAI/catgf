...
GLIF_APP_ID = 'cm2leylnc000ahfnjp0cdr4jx'  # Replace with your actual Glif app ID
...
def main():
    ...
    if last_tweet:
        ...
        replies_texts = get_top_liked_replies(last_tweet.id, username, top_n=5)

        if replies_texts:
            # Interactive loop to approve or regenerate the tweet
            while True:
                # Send the replies to the Glif API
